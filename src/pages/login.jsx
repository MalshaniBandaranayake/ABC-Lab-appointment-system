...
export function Login() {
  ...
  const handleLogin = (e) => {
    ...
    if (username === 'admin' && password === 'admin123') {
      ...
      // You can replace the link with the actual route to your admin home page
    ...
    // Check if the entered credentials match the hardcoded ones for doctors
      ...
      // You can replace the link with the actual route to your doctor home page
      window.location.href = '/doctor';
    } 

    else if (username === 'labtech' && password === 'labtech789') {
      // Redirect to lab technician dashboard
      // You can replace the link with the actual route to your lab technician home page
